...
export default function Menu() {
  const menuItems = [
    ...
    },
    {
      ...
      category: "Starters",
      price: 50,
      desc: "Crispy golden fries served in a cup",
    ...
    {
      id: 8,
      name: "1 Small Cold Coffee",
      category: "Beverages",
      price: 30,
      desc: "Small refreshing cold coffee",
      img:twocoffee,
      rating: 4.8,
      time: "14 min",
      isVeg: true
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white pb-20">
      ...
      <div className="bg-black py-8 border-b border-zinc-800">
        ...
        <p className="text-center text-zinc-400 mt-2 text-lg">Thane, Mumbra</p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-10 pb-12">
        ...
        {/* Improved Grid - 2 columns on phone, better spacing */}
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
          {menuItems.map((item) => (
            <div
              key={item.id}
            ...
            >
              ...
              <div className="relative">
                <img
                  src={item.img}
                  alt={item.name}
                  className="w-full h-52 sm:h-60 object-cover rounded-t-3xl 
                ...
                {/* Rating */}
                {/* <div className="absolute top-4 right-4 bg-black/90 backdrop-blur-md px-3 py-1 
                                rounded-full text-sm font-medium flex items-center gap-1 shadow-lg">
                  ⭐ {item.rating}
                </div> */}
              </div>
              ...
              <div className="p-5 flex flex-col flex-1">
                <div className="flex justify-between items-start mb-3">
                  <div className="flex-1">
                    ...
                    <p className="text-amber-400 font-semibold text-xl mt-2">₹{item.price}</p>
                  </div>
                  
                </div>
                <div className="mt-3 self-end bg-zinc-800 px-3 py-1 rounded-full text-sm flex items-center gap-1">
  ⭐ {item.rating}
</div>
                ...
                {/* Optional Add Button - You can activate later */}
                {/* <button className="mt-4 w-full bg-amber-500 hover:bg-amber-600 text-black font-semibold py-3 rounded-2xl transition-colors">
                  Add to Cart
                </button> */}
              </div>
            </div>
      ...
      {/* Contact Section */}
      <div className="bg-zinc-900 border-t border-zinc-800 mt-8 py-12 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10 text-center md:text-left">
          <div>
            ...
            <p className="text-zinc-400">
              Top Moon  <br />
              In front of the Samrat Nagar gate, beside the Mumbra police station. <br />
              Thane, Mumbra - 400612
            </p>
          </div>
